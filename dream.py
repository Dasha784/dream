...
def build_interpret_prompt(struct_json: str, mode: str, lang: str) -> str:
    ...
    if lang == "ru":
        example = (
            ...
            "PSYCH: 3–6 предложений живого анализа с опорой на детали сна\n"
            "ESOTERIC: 1 абзац, только если уместно (иначе оставь пусто)\n"
            "ADVICE: 2–3 строки практичного тёплого совета\n"
        )
    elif lang == "uk":
        example = (
            ...
            "PSYCH: 3–6 речень живого аналізу з опорою на деталі сну\n"
            "ESOTERIC: 1 абзац, лише якщо доречно (інакше порожньо)\n"
            "ADVICE: 2–3 рядки практичної поради\n"
        )
    else:
        example = (
            ...
            "PSYCH: 3–6 sentences of grounded, warm analysis\n"
            "ESOTERIC: one paragraph only if appropriate (else empty)\n"
            "ADVICE: 2–3 practical lines\n"
        )
    scaling_ru = (
